...
class UtilsKy:
       ...
       # ky9
       PATH_DATA_KY9 = '/mnt/files/workdata/work/merchants/merchant_32_ky9_2020-05-12_white_visa/04_experiments/ex_05_ky9_xgb_jupiter_2020_07_08/'
       DB_TEACH_KY9 = PATH_DATA_KY9 + 'db_teach_xgb_ky9.csv'
       DB_TEST_KY9 = PATH_DATA_KY9 + 'db_test_xgb_ky9.csv'
       WHITE_KY9 = PATH_DATA_KY9 + 'white_list_ky9_expeiment_trusted_2019-12-17.csv'
